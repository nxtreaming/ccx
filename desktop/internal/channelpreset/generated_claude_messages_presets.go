...
func generatedClaudeMessagesTargetConfigs() map[string]channelTargetConfig {
	return map[string]channelTargetConfig{
		"deepseek":      channelTargetConfig{ModelMapping: map[string]string{"fable": "deepseek-v4-pro", "haiku": "deepseek-v4-flash", "opus": "deepseek-v4-pro", "sonnet": "deepseek-v4-pro"}, ReasoningParamStyle: "reasoning", PassbackReasoningContent: true, PassbackThinkingBlocks: true, NormalizeSystemRoleToTopLevel: true, NoVision: true, StripEmptyTextBlocks: true, StripImageGenerationTool: true},
		"mimo":          channelTargetConfig{ModelMapping: map[string]string{"fable": "mimo-v2.5-pro", "haiku": "mimo-v2.5-pro", "opus": "mimo-v2.5-pro", "sonnet": "mimo-v2.5-pro"}, ReasoningMapping: map[string]string{"fable": "max", "haiku": "high", "mimo-v2.5": "max", "opus": "max", "sonnet": "max"}, ReasoningParamStyle: "thinking", PassbackReasoningContent: true, NormalizeSystemRoleToTopLevel: true, NoVisionModels: []string{"mimo-v2.5-pro"}, VisionFallbackModel: "mimo-v2.5", RateLimitRPM: 80},
		"compshare":     channelTargetConfig{ModelMapping: map[string]string{"fable": "glm-5.2", "haiku": "deepseek-v4-flash", "opus": "glm-5.2", "sonnet": "glm-5.2"}, ReasoningMapping: map[string]string{"MiniMax-M2.7": "xhigh", "fable": "max", "haiku": "high", "opus": "max", "sonnet": "max"}, ReasoningParamStyle: "reasoning", PassbackReasoningContent: true, PassbackThinkingBlocks: true, NormalizeSystemRoleToTopLevel: true, NoVisionModels: []string{"glm-5.2", "deepseek-v4-flash"}, VisionFallbackModel: "MiniMax-M2.7", StripEmptyTextBlocks: true},
		...
		"opencode-go":   channelTargetConfig{ModelMapping: map[string]string{"fable": "glm-5.2", "haiku": "deepseek-v4-flash", "opus": "glm-5.2", "sonnet": "glm-5.2"}, ReasoningMapping: map[string]string{"fable": "max", "haiku": "high", "opus": "max", "sonnet": "max"}, NormalizeSystemRoleToTopLevel: true},
